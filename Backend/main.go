...
func main() {
	...
	fmt.Println("  POST   /api/reset-password")
	fmt.Println("  GET    /api/foodstalls")
	fmt.Println("  GET    /api/foodstalls/:id/menu")
	fmt.Println("  GET    /api/menu-items")
	fmt.Println("  GET    /api/menu-items/by-name?name=...")
	fmt.Println("Protected Routes (require JWT token):")
	fmt.Println("  GET    /api/users")
	fmt.Println("  GET    /api/user/:id")
	fmt.Println("  PUT    /api/user/:id")
	fmt.Println("  DELETE /api/user/:id")
